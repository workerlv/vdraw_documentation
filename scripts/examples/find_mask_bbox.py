...
def raw_usage():
    ...
    st.code(
        """
            ...
            bboxes = find.mask_bboxes(mask) # returns list of bounding boxes (BBox objects)
    ...
    col_2.image(debug_image, caption="image with bboxes")
